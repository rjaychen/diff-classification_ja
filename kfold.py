...
def main(
    ...
    n_folds: int = typer.Option(5, "--n-folds", "-n", help="Number of folds for cross-validation.", show_default=True),
    ...
    use_gpu: int = typer.Option(-1, help="GPU id to use. Pass -1 to use the CPU."),
    # fmt: on
):
